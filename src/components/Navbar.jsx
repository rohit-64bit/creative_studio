...
const Navbar = () => {
  const navItems = [
    ...
    { name: 'Portfolio', href: '/portfolio', hashLink: false },
    {
      name: 'Services',
      href: '/services',
              ...
              item.dropdown ? (
                <div key={index} className="relative dropdown-parent">
                  ...
                  {activeDropdown === index && (
                    <div className="absolute bg-white text-sm text-black mt-4 rounded shadow-lg min-w-[230px] z-20 -ml-10 flex flex-col gap-2 p-2">
      ...
      >
        ...
        <nav className='flex flex-col gap-6 p-6'>
          ...
          <Link
            to={calendlyLink}
            onClick={() => setMenuOpen(false)}
            className='bg-white text-black px-6 py-2 rounded-full text-center hover:bg-blue-400 hover:text-white transition-colors duration-300'
          >
            Book a Call
          </Link>
        </nav>
